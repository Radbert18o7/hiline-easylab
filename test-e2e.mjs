...
import { processLabelsPdf } from './lib/pdfProcessor.js';
...
async function runTest() {
  try {
    ...
    console.log("Running processLabelsPdf locally...");
    const result = await processLabelsPdf(labelBuffer, pickwaveBuffer);
