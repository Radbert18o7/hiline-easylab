...
async function performCloudOCR(pngBuffer) {
  ...
  try {
    ...
    body.append('base64Image', 'data:image/png;base64,' + pngBuffer.toString('base64'));
    body.append('apikey', 'K86968038988957'); // Public Free OCR API Key
    body.append('language', 'eng');
    body.append('isOverlayRequired', 'true'); // Required for bounding boxes
